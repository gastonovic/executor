...
public class Application extends quickfix.MessageCracker implements quickfix.Application {
    ...
    public Application(SessionSettings settings,MarketDataProvider marketDataProvider) throws ConfigError, FieldConvertError {
        this.setMarketDataProvider(marketDataProvider);
